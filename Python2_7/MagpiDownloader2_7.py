import urllib2
import os
"""13/dec/2016 MagPi download script for Python 2.7"""
...
"""
    response = urllib2.urlopen("https://www.raspberrypi.org/magpi-issues/")
    html = response.read()
    links = html.split("\"")
...
directory = raw_input("Enter a directory to save files: ")
